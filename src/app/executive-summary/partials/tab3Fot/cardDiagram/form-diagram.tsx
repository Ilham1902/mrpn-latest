  ...
  <Grid container spacing={2}>
   <Grid item xs={12}>
    <FormControl fullWidth>
     <FieldLabelInfo title="Nomenklatur Kegiatan Prioritas" />
     <Typography fontWeight={600}>{rkpState?.value ?? ""}</Typography>
    </FormControl>
   </Grid>
   <Grid item xs={12}>
    <FormControl fullWidth>
     <FieldLabelInfo
      ...
      information={
       <>
        ...
        <p>
         Tujuan spesifik yang ingin dicapai melalui implementasi strategi dan
         kebijakan pembangunan
        </p>
       </>
      }
     />
     <Typography fontWeight={600}>{support?.sasaran[0].value ?? ""}</Typography>
    </FormControl>
   </Grid>
   <Grid item xs={12}>
    <FormControl fullWidth>
     <FieldLabelInfo title="Strategi TOWS" />
     {dataTows && <StrategyTowsContent data={dataTows} />}
    </FormControl>
   </Grid>
   <Grid item xs={12}>
    <FormControl fullWidth>
     <FieldLabelInfo title="Sumber Pendanaan" />
   ...
   <Grid item xs={12}>
    <FormControl fullWidth>
     <FieldLabelInfo title="Indikasi K/L/D Badan Usaha" />
     <AutocompleteSelectMultiple
   ...
   <Grid item xs={12}>
    <FormControl fullWidth>
     <FieldLabelInfo title="Indikasi Lokasi" />
     <AutocompleteSelectMultiple
