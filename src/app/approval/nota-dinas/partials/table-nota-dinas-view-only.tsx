            ...
            <Table sx={{minWidth: 650, td: {border: 0}}} size="small">
              <TableBody>
                      ...
                      {notaDinas.usulan_objek_ls.length > 1 ?
                        <List sx={{p: 0}}>
                          {notaDinas.usulan_objek_ls.map((x,index) =>
                            <ListItem sx={{padding: 0, margin: 0}}>{`${index+1}. ${x}`}</ListItem>
                          )}
                        </List>
                        :
                ...
                <TableCell sx={{verticalAlign: "top"}}>
                  ...
                  <TableCell sx={{verticalAlign: "top"}}>
                    <Typography>
                      {notaDinas.penjelasan_objek_mrpn}
                    </Typography>
                  </TableCell>
                </TableRow>
              </TableBody>
            ...
            <Table sx={{minWidth: 650, td: {border: 0}}} size="small">
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell sx={{verticalAlign: "top"}}>
                    <Typography>
                      {notaDinas.penjelasan_usulan_upr}
                    </Typography>
                  </TableCell>
                </TableRow>
              </TableBody>
                ...
                <TableRow>
                    ...
                    <Box position="relative" width="auto" display="inline-block">
                      <Box position="relative" zIndex={1}>
                        {notaDinas.ttd_pembuat &&
                            <Image
                                alt="Dibuat oleh"
                                src={process.env.NEXT_PUBLIC_BASE_URL_FILES + notaDinas.ttd_pembuat}
                                width={0}
                                height={0}
                                sizes="100vw"
                      ...
                      <Box position="absolute" top={-70} left={-70} zIndex={0}>
                        {notaDinas.alasan_ttd_pembuat && !notaDinas.approve_ttd_pembuat && (
                          <Image
                            alt="Dibuat oleh"
                  ...
                  <TableCell align="center">
                    <Box position="relative" width="auto" display="inline-block">
                      ...
                      <Box position="absolute" top={-70} left={-70} zIndex={0}>
                        {notaDinas.alasan_ttd_penyetuju && !notaDinas.approve_ttd_penyetuju && (
                          <Image
                            alt="Disetujui oleh"
                            src="https://res.cloudinary.com/caturteguh/image/upload/v1721703228/mrpn/ttd/stamp-rejected_gdzucv.png"
                            width={0}
