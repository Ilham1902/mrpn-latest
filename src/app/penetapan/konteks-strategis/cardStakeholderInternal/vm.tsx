...
import {
  initKonstraStakeholderInternalReqDto,
  KonstraStakeholderInternalReqDto,
  KonstraStakeholderInternalResDto
} from "@/app/penetapan/konteks-strategis/cardStakeholderInternal/model";
import {doCreate, doGet, doUpdate} from "@/app/penetapan/konteks-strategis/cardStakeholderInternal/service";
...
const useCardStakeholderInternalVM = () => {
  ...
  const [data, setData] = useState<KonstraStakeholderInternalResDto[]>([])
  const [request, setRequest] = useState<KonstraStakeholderInternalReqDto>(initKonstraStakeholderInternalReqDto)
  ...
  async function getDataStakeholderInternal(){
    ...
    if (response?.code == API_CODE.success){
      ...
      const genereteReq:KonstraStakeholderInternalReqDto = {
        ...request
      }
      result.map(res => {
